...
export const ACHIEVEMENTS_LIST = [
  ...
  { key: 'speed_600', title: '음속 돌파', description: '600타/분 달성', icon: '💎' },
  { key: 'perfect_game', title: '퍼펙트게임', description: '게임 모드 100% 정확도', icon: '🌟' },
  { key: 'game_master', title: '게임 마스터', description: '게임 한 판 1000점 이상', icon: '👑' },
  ...
  { key: 'veteran', title: '베테랑', description: '누적 100세션 완료', icon: '🎖️' },
  { key: 'marathon', title: '마라톤', description: '총 연습 시간 50시간', icon: '🏃' },
